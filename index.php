...
var map = new ol.Map({
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_IDM_2021_PERKIM_AR/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
	 ...
	 new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_POTENSI_DESA/MapServer',
				}),
			name: 'Trasportation',
			LegenUrl: '',
			LegentType :'ESRI',
  ...
  new  ol.layer.Tile({
			source: new ol.source.TileArcGISRest({
				url: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_CH_Dasarian_I_Januari_2021_AR_250K/MapServer',
			}),
		name: 'World Label',
		LegenUrl:'',
		LegentType :'ESRI',
